...
```
/epicspec:create-spec  →  /epicspec:create-stories  →  /epicspec:implement-story
        │                          │                             │
  6-phase structured          reads spec,               one story at a time,
  conversation →              proposes breakdown →      task → verify → next
  spec.md                     story files
```
