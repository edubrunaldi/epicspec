...
Read the story files in `epicspec/epics/<feature-name>/stories/`. For each file, check its `Status:` field.
...
Location: epicspec/epics/<feature-name>/  →  epicspec/epics/archive/<feature-name>/
...
2. Move `epicspec/epics/<feature-name>/` to `epicspec/epics/archive/<feature-name>/`
3. Open every `.md` file in `epicspec/epics/archive/<feature-name>/stories/` and update its `Status:` field to `Archived`
...
Moved to: epicspec/epics/archive/<feature-name>/
Stories marked Archived: N

To review:
  epicspec/epics/archive/<feature-name>/spec.md
  epicspec/epics/archive/<feature-name>/stories/
```
